...
public class Board {
	...
	private void initHexes() {
		...
		mapHexes[1][1] = null;
		mapHexes[1][2] = null;
		mapHexes[1][3] = new Hex(this,3,1, hexTypeAssignments[6], hexRollValueAssignments[6]);
		mapHexes[1][4] = new Hex(this,4,1, hexTypeAssignments[5], hexRollValueAssignments[5]);
		mapHexes[1][5] = new Hex(this,5,1, hexTypeAssignments[4], hexRollValueAssignments[4]);

		mapHexes[2][0] = null;
		mapHexes[2][1] = null;
		mapHexes[2][2] = new Hex(this,2,2, hexTypeAssignments[7],  hexRollValueAssignments[7]);
		mapHexes[2][3] = new Hex(this,3,2, hexTypeAssignments[15], hexRollValueAssignments[15]);
		mapHexes[2][4] = new Hex(this,4,2, hexTypeAssignments[14], hexRollValueAssignments[14]);
		mapHexes[2][5] = new Hex(this,5,2, hexTypeAssignments[3],  hexRollValueAssignments[3]);

		mapHexes[3][0] = null;
		mapHexes[3][1] = new Hex(this,1,3, hexTypeAssignments[8],  hexRollValueAssignments[8]);
		mapHexes[3][2] = new Hex(this,2,3, hexTypeAssignments[16], hexRollValueAssignments[16]);
		mapHexes[3][3] = new Hex(this,3,3, hexTypeAssignments[18], hexRollValueAssignments[18]);
		mapHexes[3][4] = new Hex(this,4,3, hexTypeAssignments[13], hexRollValueAssignments[13]);
		mapHexes[3][5] = new Hex(this,5,3, hexTypeAssignments[2],  hexRollValueAssignments[2]);

		mapHexes[4][0] = null;
		mapHexes[4][1] = new Hex(this,1,4, hexTypeAssignments[9],  hexRollValueAssignments[9]);
		mapHexes[4][2] = new Hex(this,2,4, hexTypeAssignments[17], hexRollValueAssignments[17]);
		mapHexes[4][3] = new Hex(this,3,4, hexTypeAssignments[12], hexRollValueAssignments[12]);
		mapHexes[4][4] = new Hex(this,4,4, hexTypeAssignments[1],  hexRollValueAssignments[1]);
		mapHexes[4][5] = null;

		mapHexes[5][0] = null;
		mapHexes[5][1] = new Hex(this,1,5, hexTypeAssignments[10], hexRollValueAssignments[10]);
		mapHexes[5][2] = new Hex(this,2,5, hexTypeAssignments[11], hexRollValueAssignments[11]);
		mapHexes[5][3] = new Hex(this,3,5, hexTypeAssignments[0],  hexRollValueAssignments[0]);
		mapHexes[5][4] = null;
		mapHexes[5][5] = null;
	}
	...
	private void initULBorders() {
		...
		mapULEdges[1][1] = null;
		mapULEdges[1][2] = null;
		mapULEdges[1][3] = new Edge(this,3,1,ModEdgeDirection.LEFT);
		mapULEdges[1][4] = new Edge(this,4,1,ModEdgeDirection.LEFT);
		mapULEdges[1][5] = new Edge(this,5,1,ModEdgeDirection.LEFT);
		mapULEdges[1][6] = new Edge(this,6,1,ModEdgeDirection.LEFT);

		mapULEdges[2][0] = null;
		mapULEdges[2][1] = null;
		mapULEdges[2][2] = new Edge(this,2,2,ModEdgeDirection.LEFT);
		mapULEdges[2][3] = new Edge(this,3,2,ModEdgeDirection.LEFT);
		mapULEdges[2][4] = new Edge(this,4,2,ModEdgeDirection.LEFT);
		mapULEdges[2][5] = new Edge(this,5,2,ModEdgeDirection.LEFT);
		mapULEdges[2][6] = new Edge(this,6,2,ModEdgeDirection.LEFT);

		mapULEdges[3][0] = null;
		mapULEdges[3][1] = new Edge(this,1,3,ModEdgeDirection.LEFT);
		mapULEdges[3][2] = new Edge(this,2,3,ModEdgeDirection.LEFT);
		mapULEdges[3][3] = new Edge(this,3,3,ModEdgeDirection.LEFT);
		mapULEdges[3][4] = new Edge(this,4,3,ModEdgeDirection.LEFT);
		mapULEdges[3][5] = new Edge(this,5,3,ModEdgeDirection.LEFT);
		mapULEdges[3][6] = new Edge(this,6,3,ModEdgeDirection.LEFT);

		mapULEdges[4][0] = null;
		mapULEdges[4][1] = new Edge(this,1,4,ModEdgeDirection.LEFT);
		mapULEdges[4][2] = new Edge(this,2,4,ModEdgeDirection.LEFT);
		mapULEdges[4][3] = new Edge(this,3,4,ModEdgeDirection.LEFT);
		mapULEdges[4][4] = new Edge(this,4,4,ModEdgeDirection.LEFT);
		mapULEdges[4][5] = new Edge(this,5,4,ModEdgeDirection.LEFT);
		mapULEdges[4][6] = null;

		mapULEdges[5][0] = null;
		mapULEdges[5][1] = new Edge(this,1,5,ModEdgeDirection.LEFT);
		mapULEdges[5][2] = new Edge(this,2,5,ModEdgeDirection.LEFT);
		mapULEdges[5][3] = new Edge(this,3,5,ModEdgeDirection.LEFT);
		mapULEdges[5][4] = new Edge(this,4,5,ModEdgeDirection.LEFT);
		mapULEdges[5][5] = null;
		mapULEdges[5][6] = null;
	...
	private void initUUBorders() {
		...
		mapUUEdges[1][1] = null;
		mapUUEdges[1][2] = null;
		mapUUEdges[1][3] = new Edge(this,3,1,ModEdgeDirection.UP);
		mapUUEdges[1][4] = new Edge(this,4,1,ModEdgeDirection.UP);
		mapUUEdges[1][5] = new Edge(this,5,1,ModEdgeDirection.UP);
		mapUUEdges[1][6] = null;

		mapUUEdges[2][0] = null;
		mapUUEdges[2][1] = null;
		mapUUEdges[2][2] = new Edge(this,2,2,ModEdgeDirection.UP);
		mapUUEdges[2][3] = new Edge(this,3,2,ModEdgeDirection.UP);
		mapUUEdges[2][4] = new Edge(this,4,2,ModEdgeDirection.UP);
		mapUUEdges[2][5] = new Edge(this,5,2,ModEdgeDirection.UP);
		mapUUEdges[2][6] = null;

		mapUUEdges[3][0] = null;
		mapUUEdges[3][1] = new Edge(this,1,3,ModEdgeDirection.UP);
		mapUUEdges[3][2] = new Edge(this,2,3,ModEdgeDirection.UP);
		mapUUEdges[3][3] = new Edge(this,3,3,ModEdgeDirection.UP);
		mapUUEdges[3][4] = new Edge(this,4,3,ModEdgeDirection.UP);
		mapUUEdges[3][5] = new Edge(this,5,3,ModEdgeDirection.UP);
		mapUUEdges[3][6] = null;

		mapUUEdges[4][0] = null;
		mapUUEdges[4][1] = new Edge(this,1,4,ModEdgeDirection.UP);
		mapUUEdges[4][2] = new Edge(this,2,4,ModEdgeDirection.UP);
		mapUUEdges[4][3] = new Edge(this,3,4,ModEdgeDirection.UP);
		mapUUEdges[4][4] = new Edge(this,4,4,ModEdgeDirection.UP);
		mapUUEdges[4][5] = new Edge(this,5,4,ModEdgeDirection.UP);
		mapUUEdges[4][6] = null;

		mapUUEdges[5][0] = null;
		mapUUEdges[5][1] = new Edge(this,1,5,ModEdgeDirection.UP);
		mapUUEdges[5][2] = new Edge(this,2,5,ModEdgeDirection.UP);
		mapUUEdges[5][3] = new Edge(this,3,5,ModEdgeDirection.UP);
		mapUUEdges[5][4] = new Edge(this,4,5,ModEdgeDirection.UP);
		mapUUEdges[5][5] = null;
		mapUUEdges[5][6] = null;

		mapUUEdges[6][0] = null;
		mapUUEdges[6][1] = new Edge(this,1,6,ModEdgeDirection.UP);
		mapUUEdges[6][2] = new Edge(this,2,6,ModEdgeDirection.UP);
		mapUUEdges[6][3] = new Edge(this,3,6,ModEdgeDirection.UP);
		mapUUEdges[6][4] = null;
		mapUUEdges[6][5] = null;
		mapUUEdges[6][6] = null;
	}
	...
	private void initURBorders() {
		...
		mapUREdges[1][1] = null;
		mapUREdges[1][2] = null;
		mapUREdges[1][3] = new Edge(this,3,1,ModEdgeDirection.RIGHT);
		mapUREdges[1][4] = new Edge(this,4,1,ModEdgeDirection.RIGHT);
		mapUREdges[1][5] = new Edge(this,5,1,ModEdgeDirection.RIGHT);
		mapUREdges[1][6] = null;

		mapUREdges[2][0] = null;
		mapUREdges[2][1] = null;
		mapUREdges[2][2] = new Edge(this,2,2,ModEdgeDirection.RIGHT);
		mapUREdges[2][3] = new Edge(this,3,2,ModEdgeDirection.RIGHT);
		mapUREdges[2][4] = new Edge(this,4,2,ModEdgeDirection.RIGHT);
		mapUREdges[2][5] = new Edge(this,5,2,ModEdgeDirection.RIGHT);
		mapUREdges[2][6] = null;

		mapUREdges[3][0] = null;
		mapUREdges[3][1] = new Edge(this,1,3,ModEdgeDirection.RIGHT);
		mapUREdges[3][2] = new Edge(this,2,3,ModEdgeDirection.RIGHT);
		mapUREdges[3][3] = new Edge(this,3,3,ModEdgeDirection.RIGHT);
		mapUREdges[3][4] = new Edge(this,4,3,ModEdgeDirection.RIGHT);
		mapUREdges[3][5] = new Edge(this,5,3,ModEdgeDirection.RIGHT);
		mapUREdges[3][6] = null;

		mapUREdges[4][0] = new Edge(this,0,4,ModEdgeDirection.RIGHT);
		mapUREdges[4][1] = new Edge(this,1,4,ModEdgeDirection.RIGHT);
		mapUREdges[4][2] = new Edge(this,2,4,ModEdgeDirection.RIGHT);
		mapUREdges[4][3] = new Edge(this,3,4,ModEdgeDirection.RIGHT);
		mapUREdges[4][4] = new Edge(this,4,4,ModEdgeDirection.RIGHT);
		mapUREdges[4][5] = null;
		mapUREdges[4][6] = null;

		mapUREdges[5][0] = new Edge(this,0,5,ModEdgeDirection.RIGHT);
		mapUREdges[5][1] = new Edge(this,1,5,ModEdgeDirection.RIGHT);
		mapUREdges[5][2] = new Edge(this,2,5,ModEdgeDirection.RIGHT);
		mapUREdges[5][3] = new Edge(this,3,5,ModEdgeDirection.RIGHT);
		mapUREdges[5][4] = null;
		mapUREdges[5][5] = null;
		mapUREdges[5][6] = null;

		mapUREdges[6][0] = new Edge(this,0,6,ModEdgeDirection.RIGHT);
		mapUREdges[6][1] = new Edge(this,1,6,ModEdgeDirection.RIGHT);
		mapUREdges[6][2] = new Edge(this,2,6,ModEdgeDirection.RIGHT);
		mapUREdges[6][3] = null;
		mapUREdges[6][4] = null;
		mapUREdges[6][5] = null;
		mapUREdges[6][6] = null;
	...
	private void initVertices() {
		...
		mapVertices[0][6] = new Vertex(this,6,0, null);
		mapVertices[0][7] = null;
		mapVertices[0][8] = new Vertex(this,8,0, new TradePort(portTypeAssignments[4]));
		mapVertices[0][9] = null;
		mapVertices[0][10] = new Vertex(this,10,0, new TradePort(portTypeAssignments[3]));
		...
		mapVertices[1][5] = new Vertex(this,5,1, null);
		mapVertices[1][6] = null;
		mapVertices[1][7] = new Vertex(this,7,1, new TradePort(portTypeAssignments[4]));
		mapVertices[1][8] = null;
		mapVertices[1][9] = new Vertex(this,9,1, null);
		mapVertices[1][10] = null;
		mapVertices[1][11] = new Vertex(this,11,1, new TradePort(portTypeAssignments[3]));

		mapVertices[2][0] = null;
		mapVertices[2][1] = null;
		mapVertices[2][2] = null;
		mapVertices[2][3] = null;
		mapVertices[2][4] = new Vertex(this,4,2, new TradePort(portTypeAssignments[5]));
		mapVertices[2][5] = null;
		mapVertices[2][6] = new Vertex(this,6,2, null);
		mapVertices[2][7] = null;
		mapVertices[2][8] = new Vertex(this,8,2, null);
		mapVertices[2][9] = null;
		mapVertices[2][10] = new Vertex(this,10,2, null);
		...
		mapVertices[3][5] = new Vertex(this,5,3, null);
		mapVertices[3][6] = null;
		mapVertices[3][7] = new Vertex(this,7,3, null);
		mapVertices[3][8] = null;
		mapVertices[3][9] = new Vertex(this,9,3, null);
		mapVertices[3][10] = null;
		mapVertices[3][11] = new Vertex(this,11,3, new TradePort(portTypeAssignments[2]));

		mapVertices[4][0] = null;
		mapVertices[4][1] = null;
		mapVertices[4][2] = new Vertex(this,2,4, null);
		mapVertices[4][3] = null;
		mapVertices[4][4] = new Vertex(this,4,4, null);
		mapVertices[4][5] = null;
		mapVertices[4][6] = new Vertex(this,6,4, null);
		mapVertices[4][7] = null;
		mapVertices[4][8] = new Vertex(this,8,4, null);
		mapVertices[4][9] = null;
		mapVertices[4][10] = new Vertex(this,10,4, new TradePort(portTypeAssignments[2]));
		mapVertices[4][11] = null;

		mapVertices[5][0] = null;
		mapVertices[5][1] = new Vertex(this,1,5, new TradePort(portTypeAssignments[6]));
		mapVertices[5][2] = null;
		mapVertices[5][3] = new Vertex(this,3,5, null);
		mapVertices[5][4] = null;
		mapVertices[5][5] = new Vertex(this,5,5, null);
		mapVertices[5][6] = null;
		mapVertices[5][7] = new Vertex(this,7,5, null);
		mapVertices[5][8] = null;
		mapVertices[5][9] = new Vertex(this,9,5, null);
		mapVertices[5][10] = null;
		mapVertices[5][11] = new Vertex(this,11,5, null);

		mapVertices[6][0] = new Vertex(this,0,6, new TradePort(portTypeAssignments[6]));
		mapVertices[6][1] = null;
		mapVertices[6][2] = new Vertex(this,2,6, null);
		mapVertices[6][3] = null;
		mapVertices[6][4] = new Vertex(this,4,6, null);
		mapVertices[6][5] = null;
		mapVertices[6][6] = new Vertex(this,6,6, null);
		mapVertices[6][7] = null;
		mapVertices[6][8] = new Vertex(this,8,6, null);
		mapVertices[6][9] = null;
		mapVertices[6][10] = new Vertex(this,10,6, null);
		mapVertices[6][11] = null;

		mapVertices[7][0] = null;
		mapVertices[7][1] = new Vertex(this,1,7, null);
		mapVertices[7][2] = null;
		mapVertices[7][3] = new Vertex(this,3,7, null);
		mapVertices[7][4] = null;
		mapVertices[7][5] = new Vertex(this,5,7, null);
		mapVertices[7][6] = null;
		mapVertices[7][7] = new Vertex(this,7,7, null);
		mapVertices[7][8] = null;
		mapVertices[7][9] = new Vertex(this,9,7, new TradePort(portTypeAssignments[1]));
		mapVertices[7][10] = null;
		mapVertices[7][11] = null;

		mapVertices[8][0] = new Vertex(this,0,8, new TradePort(portTypeAssignments[7]));
		mapVertices[8][1] = null;
		mapVertices[8][2] = new Vertex(this,2,8, null);
		mapVertices[8][3] = null;
		mapVertices[8][4] = new Vertex(this,4,8, null);
		mapVertices[8][5] = null;
		mapVertices[8][6] = new Vertex(this,6,8, null);
		...
		mapVertices[9][1] = new Vertex(this,1,9, new TradePort(portTypeAssignments[7]));
		mapVertices[9][2] = null;
		mapVertices[9][3] = new Vertex(this,3,9, null);
		mapVertices[9][4] = null;
		mapVertices[9][5] = new Vertex(this,5,9, null);
		mapVertices[9][6] = null;
		mapVertices[9][7] = new Vertex(this,7,9, null);
		...
		mapVertices[10][2] = new Vertex(this,2,10, new TradePort(portTypeAssignments[8]));
		mapVertices[10][3] = null;
		mapVertices[10][4] = new Vertex(this,4,10, null);
		mapVertices[10][5] = null;
		mapVertices[10][6] = new Vertex(this,6,10, new TradePort(portTypeAssignments[0]));
		...
		mapVertices[11][1] = new Vertex(this,1,11, null);
		mapVertices[11][2] = null;
		mapVertices[11][3] = new Vertex(this,3,11, new TradePort(portTypeAssignments[8]));
		mapVertices[11][4] = null;
		mapVertices[11][5] = new Vertex(this,5,11, new TradePort(portTypeAssignments[0]));

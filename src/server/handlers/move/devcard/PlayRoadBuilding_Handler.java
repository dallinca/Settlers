...
public class PlayRoadBuilding_Handler extends SettlersOfCatanHandler{
	...
	public void handle(HttpExchange exchange) throws IOException {
		...
		String job;	
		PlayRoadBuilding_Params request;
		...
		if (check.equals("VALID")){
			...
			request = gson.fromJson(job, PlayRoadBuilding_Params.class); //deserialize request from json

			PlayRoadBuilding_Command command = new PlayRoadBuilding_Command(request, gameID, user.getPlayerID());
